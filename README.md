# Polars And Functime: How To Innovate Time Series Forecasting
...
```bash
# with github CLI
gh repo clone baggiponte/kaggledays-functime

# with git
git clone git@github.com:baggiponte/kaggledays-functime
```
